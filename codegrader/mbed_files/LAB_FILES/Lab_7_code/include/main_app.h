...
// Define the threads
Thread t1; // do not change name
Thread t2; // do not change name
Thread t3; // do not change name
...
// D6 and D8 are used for tests for DISCOF746 board
// choose free pins depending on board used
DigitalInOut pause(D6);
DigitalInOut get_input(D8); //D7
...
// #if MBED_TEST_MODE
// // DigitalOutIn pause(USER_BUTTON);
// // DigitalOutIn get_input(BUTTON_1);

// DigitalOutIn pause(D6);
// DigitalOutIn get_input(D8); //D7
// #else
// // use free pins
// // check your board pin layout
// // For ST DISCOF746GN = D6 and D8
// // DigitalOutIn pause(D6);
// // DigitalOutIn get_input(D8); //D7
