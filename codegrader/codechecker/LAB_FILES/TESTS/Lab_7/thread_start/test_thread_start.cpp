/*H**********************************************************************
* FILENAME : test_thread_start.cpp          DESIGN REF:
*
* DESCRIPTION :
*       Test that thread start and thread termination functions work for the player.
*
* PUBLIC FUNCTIONS :
*
* NOTES :
...
// Testcase to check that threads start if thread_starter() an terminates when
// thread_terminator() is called
