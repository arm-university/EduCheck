/*H**********************************************************************
* FILENAME : test_play_song.cpp          DESIGN REF:
*
* DESCRIPTION :
*       Test to determine if the song plays. The following are checked in this test:
*       Song name, player state, speaker value.
*
* PUBLIC FUNCTIONS :
*
* NOTES :
...
// Testcase to check if variable is_playing is set - this should then activate if statement in ISR
