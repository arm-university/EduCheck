/*H**********************************************************************
* FILENAME : song_def.h       DESIGN REF:
*
* DESCRIPTION :
*      Defines the note, beat and tempo of each song.
*
...
//Für Elise - Beethoven
float Fur_Elise_note[] = {Mi_2, ReD_2, Mi_2, ReD_2, Mi_2, Si, Re_2, Do_2};
float Fur_Elise_beat[] = {b3, b3, b3, b3, b3, b3, b3, b3};
...
Song FUR_ELISE = Song(string("Fur Elise -"), string("Beethoven"), &Fur_Elise_note[0], &Fur_Elise_beat[0], Fur_Elise_tempo, 8);
