...
### Python
1. Install the Python version listed in [`EduCheck\README.md`]([../README.md](https://github.com/arm-university/EduCheck/blob/main/README.md#software-requirements)) from https://www.python.org/
...
### Compiler
1. Install the GNU Arm Embedded Toolchain version listed in [`codegrader\README.md`](../README.md) from https://developer.arm.com/tools-and-software/open-source-software/developer-tools/gnu-toolchain/gnu-rm .
